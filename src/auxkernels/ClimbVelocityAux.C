...
#include "ClimbVelocityAux.h"

registerMooseObject("DummyDDApp", ClimbVelocityAux);

template <>
InputParameters
validParams<ClimbVelocityAux>()
{
...
ClimbVelocityAux::ClimbVelocityAux(const InputParameters & parameters)
